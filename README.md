...
## 핵심 결론 (n=83, 4개 관측소, 위성 통과시각 정밀매칭 Δt 중앙 9분)
- 구름은 UVA·UVB를 **통계적으로 구별 안 될 만큼 같은 비율로(회색)** 차단. 차단율은 τ에 따라 매끄럽게 커진다.
- 투과율은 산란형 **T ≈ 1/(1+0.06·τ)** 로 잘 기술됨 (UVB a=0.060, 95%CI [0.039, 0.085]).
- **먹구름(τ≈40)에서 UV의 약 70% 차단**, 옅은 구름(τ≈2) ~10%.
- 청천의 오존 흡수로 UVB만 강하게 걸러지는 맑은 하늘과는 정반대 — 구름은 파장을 안 가림.
